...
namespace MultiValueDictionary.Tests.Integration.Command
{
    public class KeysTests
    {
        ...
        [Fact]
        public void Keys_WhenNoKeys_ThenReturnsEmptySetMessage()
        {
        ...
        [Fact]
        public void Keys_WhenKeys_ThenReturnsExpectedResult()
        {
            var fakeArgs = new[] {"_ignored"};
            ...
            foreach (var (key, value) in fakeKeyValuePairs) result.Should().Contain(key);
        }
    }
}